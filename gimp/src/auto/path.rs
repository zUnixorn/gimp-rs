...
use crate::{ffi,Image,Item,Layer,OrientationType};
...
#[must_use]
    ...
    //pub fn stroke_get_points(&self, stroke_id: i32) -> (/*Ignored*/PathStrokeType, Vec<f64>, bool) {
    //    unsafe { TODO: call ffi:gimp_path_stroke_get_points() }
    //}
    ...
    //pub fn stroke_new_from_points(&self, type_: /*Ignored*/PathStrokeType, controlpoints: &[f64], closed: bool) -> i32 {
    //    unsafe { TODO: call ffi:gimp_path_stroke_new_from_points() }
    //}
